...
class Reading extends Component
{
    ...
    public function loadData()
    {
        ...
        try {
            ...
            $chartDto = $mockChartsService->getFourPillars($this->selectedPersonId);
            $this->chartData = $chartDto->toArray();
            $this->readingData = $mockReadingsService->getFourPillarsReading();
        } catch (\Exception $e) {
            $this->chartData = [];
            $this->readingData = [];
        }
    ...
    {
        return view('livewire.astrology.four-pillars.reading');
    }
}
