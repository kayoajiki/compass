...
class Reading extends Component
{
    ...
    public function loadData()
    {
        ...
        try {
            ...
            $chartDto = $mockChartsService->getZiWei($this->selectedPersonId);
            $this->chartData = $chartDto->toArray();
            $this->readingData = $mockReadingsService->getZiWeiReading();
        } catch (\Exception $e) {
            $this->chartData = [];
            $this->readingData = [];
        }
    ...
    {
        return view('livewire.astrology.zi-wei.reading');
    }
}
