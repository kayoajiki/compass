                ...
                <div class="flex flex-col flex-grow pt-5 bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
                    ...
                    <nav class="flex-1 px-4 space-y-2">
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('dashboard') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('dashboard') ? 'bg-zinc-200 text-[#4e3291] dark:bg-zinc-800 dark:text-[#4e3291]' : 'text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800' }}" wire:navigate>
