                ...
                @else
                    ...
                    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6">
                        <div class="text-center">
                            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ $readingData['title'] ?? '西洋占星術 詳細鑑定' }}</h1>
                    ...
                    <!-- 命盤表示 -->
                    <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6">
                        <h2 class="text-xl font-bold mb-4 text-center">ホロスコープ</h2>
                        @if(!empty($chartData))
                            <!-- Planets -->
                            @if(isset($chartData['planets']) && !empty($chartData['planets']))
                                <div class="mb-6">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 text-center">主要天体</h3>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                        <a href="{{ route('western.chart') }}" class="border border-purple-600 text-purple-600 hover:bg-purple-50 dark:text-purple-400 dark:hover:bg-purple-900/20 px-6 py-3 rounded-lg font-medium transition-colors">
                            盤面に戻る
                        </a>
                        <button 
                            wire:click="loadData"
