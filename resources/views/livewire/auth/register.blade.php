<div>
    ...
    <form method="POST" wire:submit="register">
        ...
        <div class="mb-6">
            ...
            <input 
                ...
                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('password_confirmation') border-red-500 @enderror"
    ...
    <div class="text-center text-sm text-gray-600">
        ...
        <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-500" wire:navigate>{{ __('Log in') }}</a>
    </div>
</div>
