        ...
        <div class="mb-8">
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('calendar.chart') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                        カレンダーを見る
                    </a>
                </div>
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        基本的な運勢カレンダーは無料でご利用いただけます。詳細な分析は有料プランでご覧いただけます。
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6 hover:shadow-md transition-shadow">
                <div class="text-center">
                    ...
                    <a href="{{ route('four-pillars.chart') }}" class="w-full bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors block">
                        鑑定する
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6 hover:shadow-md transition-shadow">
                <div class="text-center">
                    ...
                    <a href="{{ route('ziwei.chart') }}" class="w-full bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors block">
                        鑑定する
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6 hover:shadow-md transition-shadow">
                <div class="text-center">
                    ...
                    <a href="{{ route('western.chart') }}" class="w-full bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors block">
                        鑑定する
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6 hover:shadow-md transition-shadow">
                <div class="text-center">
                    ...
                    <a href="{{ route('numerology.chart') }}" class="w-full bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors block">
                        鑑定する
                    </a>
                </div>
            </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-purple-100 dark:border-zinc-700 p-6">
                <div class="text-center">
                    ...
                    <a href="{{ route('compatibility.chart') }}" class="w-full border border-purple-600 text-purple-600 hover:bg-purple-50 dark:text-purple-400 dark:hover:bg-purple-900/20 px-4 py-2 rounded-lg text-sm font-medium transition-colors block">
                        相性を占う
                    </a>
                </div>
            </div>
