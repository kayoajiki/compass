    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">申し込みがキャンセルされました</h1>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-3">再度お申し込みいただけます</h3>
                <p class="text-gray-600 mb-4">
                    キャンセルされた場合でも、いつでも再度お申し込みいただけます。
                ...
                <div class="space-y-3">
                    <div class="flex items-start space-x-3">
                        ...
                        <p class="text-sm text-gray-600">再度鑑定商品を選択してください</p>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <span class="text-xs font-bold text-purple-600">2</span>
                        </div>
                        <p class="text-sm text-gray-600">支払い情報を入力してください</p>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                            <span class="text-xs font-bold text-purple-600">3</span>
                        </div>
                        <p class="text-sm text-gray-600">支払い完了後、鑑定生成が開始されます</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="{{ route('reading-shop') }}" class="flex-1 bg-purple-600 text-white py-3 px-6 rounded-lg font-semibold text-center hover:bg-purple-700 transition-colors">
                    再度申し込む
                </a>
